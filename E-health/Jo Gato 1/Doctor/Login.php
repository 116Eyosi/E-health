                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-5">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Doctor Login</h3></div>
                                    <div class="card-body">
                                        <div>
                                        <?php
                                    session_start();
                                        ...
                                        <form action="Code.php" method="POST">
                                            ...
                                            <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                                <a class="small" href="Recoverypassword.php">Login by ID</a>
                                                <button class="btn btn-primary" name="Doctorlogin">Login</button>
                                            </div>
                                        </form>
                                    </div>
